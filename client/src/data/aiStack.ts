...
export const AI_STACK_DATA: AIStackLayer[] = [
  ...
  },
  {
    ...
    companies: [
      ...
      { ticker: "IREN", name: "IREN", role: "Bitcoin miner pivot to AI cloud — NVIDIA-backed GPU data centers; ex-Iris Energy" },
      { ticker: "CIFR", name: "Cipher Mining", role: "Bitcoin mining pivot to HPC/AI data centers — large hyperscaler colocation deals" },
      { ticker: "HUT", name: "Hut 8", role: "Bitcoin mining + AI/HPC compute buildout — power-rich data center sites" },
  ...
  },
  {
    layer: "L8",
    label: "CHIPS & SILICON",
    sublabel: "GPUs, custom ASICs & inference chips — the compute silicon",
    etf: "XSD",
    companies: [
  ...
  },
  {
    ...
    sublabel: "HBM, DDR5, CXL expansion & NAND/HDD — the memory wall is the new bottleneck",
    etf: "DRAM",
    companies: [
      { ticker: "MU", name: "Micron", role: "HBM (high-bandwidth memory) stacked on GPUs — the near-memory layer for active token generation" },
      { ticker: "SNDK", name: "SanDisk", role: "NAND flash storage — +464% YTD, $42B+ performance obligations" },
      { ticker: "ALAB", name: "Astera Labs", role: "CXL memory-fabric & PCIe retimers — pools expansion memory and connects it to the GPU" },
      { ticker: "RMBS", name: "Rambus", role: "Memory interface chips — DDR5 RCD/buffer; royalties on effectively every server DIMM" },
      { ticker: "MCHP", name: "Microchip", role: "CXL memory controllers — context switching and memory pooling for long-context inference" },
  ...
  },
  {
    ...
    companies: [
      ...
      { ticker: "GOOGL", name: "Alphabet / Google", role: "Gemini models — powers Search, YouTube, Cloud, Workspace (also L12)" },
      { ticker: "MSFT", name: "Microsoft", role: "Deeply integrated with OpenAI — Copilot across entire product suite (also L12)" },
  ...
  },
  {
    ...
    companies: [
      ...
      { ticker: "MSFT", name: "Microsoft Copilot", role: "AI across Office, Teams, GitHub, Azure (also L12/L13)" },
...
export const AI_STACK_FLOW: AIStackFlowStep[] = [
  ...
  { label: "Chips", tickers: "NVDA AVGO AMD CBRS" },
  { label: "Memory", tickers: "MU SNDK ALAB STX" },
