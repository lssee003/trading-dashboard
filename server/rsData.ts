...
const ETF_META: Record<string, { name: string; category: "Index" | "Sector" | "Industry Group" }> = {
  ...
  IBIT: { name: "Bitcoin Spot", category: "Index" },
  ...
  GRID: { name: "Electrical Grid & Infra", category: "Industry Group" },
  ...
  IDGT: { name: "Digital Infrastructure", category: "Industry Group" },
  ...
  NLR:  { name: "Nuclear Power", category: "Industry Group" },
  DRAM: { name: "Memory & DRAM", category: "Industry Group" },
  AIQ:  { name: "AI & Data Processing", category: "Industry Group" },
  MAGS: { name: "Magnificent 7", category: "Index" },
  SPMO: { name: "S&P 500 Momentum", category: "Index" },
